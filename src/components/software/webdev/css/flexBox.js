    ...
    return (
      <div>
        ...
        <p>
          ...
          create responsive and dynamic layouts, making it easier to build
          complex designs without relying heavily on floats or positioning.
        </p>
        ...
        <p>
          ...
          contains the flex items. By applying a specific set of properties to
          the container, you establish a flex context for its children. These
        ...
        <ol>
          <li>
            ...
            <code>inline-flex</code> on the flex container, enabling it to
            become a flex container and activate flexbox behavior.
          </li>
          <li>
            <strong>flex-direction</strong> property: It determines the
            direction in which flex items are placed within the container. It
            can be set to <code>row</code>, <code>row-reverse</code>,{" "}
            <code>column</code>, or <code>column-reverse</code>, allowing for
          ...
          <li>
            ...
            container. It can be set to <code>nowrap</code>, <code>wrap</code>,
            or <code>wrap-reverse</code>, influencing the flow of flex items.
          </li>
          <li>
            ...
            <code>space-around</code>, and <code>space-evenly</code>, allowing
            for various horizontal alignment options.
          </li>
          <li>
            <strong>align-items</strong> property: It specifies how flex items
            are aligned along the cross axis of the flex container. It provides
        ...
        <p>
          ...
          <code>flex-basis</code>, <code>flex</code>, and{" "}
          <code>align-self</code>.
        </p>

        <ol>
          <li>
            <strong>flex-grow</strong> property: It specifies how flex items
            grow to occupy available space along the main axis if there is extra
            space.
          </li>
          <li>
          ...
          <li>
            ...
            <code>align-items</code> value for an individual flex item,
            providing custom alignment along the cross axis.
          </li>
        </ol>
        ...
        <p>
          ...
          approach to element positioning and alignment,making it a popular
          choice for building modern web designs.
        </p>
      </div>
    );
  }
