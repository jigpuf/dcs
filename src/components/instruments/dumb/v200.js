...
const V200 = () => {
  return (
    <div>
      <h3>Video</h3>
      <li>
        <a href="https://www.youtube.com/watch?v=WVQtuR1r8Zs" target="_blank">
          V200 Positioner FullVideo Final
        </a>
      </li>
      <a
      ...
      <li>
        With no pneumatics applied, adjust cam until the black line is pointing
        at the screw and the point of the cam is not touching the screw. Lock it
        down with the set screw
      </li>
      <li>
        If there are 30 PSI gauges available, install them in the C+ and C-
        ports{" "}
      </li>
      <li>If there are no gauges, crack the c+ port to calibrate by feel</li>
      <li>Inject 4mA in the control loop terminals</li>
      <li>
        Adjust the Mechanical Zero(Inner screw) Clockwise until it registers
        above 0 PSI on the c+ gauge or until air is felt through the cracked c+
        fitting
      </li>
      <li>
        Turn mechanical Zero Counter-Clockwise slowly until c+ gauge goes to 0
        PSI or the flow stops at the cracked c+ fitting
      </li>
      <li>Inject 20mA at the control loop</li>
      <li>
        adjust the mechanical Span(outer ring) Clockwise until the c- gauges
        goes above 0 PSI or until flow is felt at the cracked c- fitting
      </li>
      <li>
        Turn mechanical Span Counter-Clockwise slowly until c- gauge goes to 0
        PSI or the flow stops at the cracked c- fitting
      </li>
      <li>
        Inject 4mA to make sure the calibration holds. Repeat if necessary
      </li>
      ...
      <li>
        Use injection meter for control circuit and multimeter for feedback.
      ...
      Turn off pneumatics. Remove the body by taking out the screw. Clean with
      electrical contact cleaner fluid. put back dry with no lubricant. The rod
      should move freely
      <br />
