...
const ArduinoHardware = () => {
  const unoHead = ["Interface", "Signal Type", "Notes"];
  const uno = [
    {
      pin: "Power",
      signals: "7-20VDC Input",
      notes: "12VDC is Ideal, 2.1 mm center positive jack",
    },
    {
      pin: "Vin",
      signals: "+7-20VDC Input",
      notes: "bare wire input, otherwise same as Power",
    },
    {
      pin: "Ground",
      signals: "0V",
      notes:
        "If power is provided from Vin, gthen Ground is landed here, board ground is found here also",
    },
    {
      pin: "Reset Button",
      signals: "Push to reset Arduino",
      notes: "This is how you restart program.  It is built for this",
    },
    {
      pin: "reset",
      signals: "Voltage to reset remotely",
      notes: "same as button but voltage controlled",
    },
    {
      pin: "5V",
      signals: "5VDC Output",
      notes: "If you need to power a 5v rail",
    },
    {
      pin: "3.3V",
      signals: "3.3V Output",
      notes: "If you need to power a 3.3V rail",
    },
    ...
    {
      pin: "13",
      signals: "Digital In/Out",
      notes:
        "This has an LED next to it for bemnch testing signale wiothout connections",
    },
    ...
    <div>
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <a
              href="https://www.arduino.cc/en/hardware#boards-1"
              target="_blank"
            >
              Boards and Shields
            </a>
          ...
          <td>
            Arduino boards and shields are the hardware that will be programed
            as a controller
          </td>
        </tr>
      </table>
      ...
      <h3>Programming</h3>
      <p>
        Arduino programs are called sketches. Once you open the arduino IDE, you
        can select the location you want the sketches to be saved to.
        Arduino--Preferences from here you can browse to the folder where it
        will be saved and you can set the IDE font.
      </p>
...
export default ArduinoHardware;
